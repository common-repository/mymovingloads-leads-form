...
/*
* LEAD FORM :: US
* This is the lead form template for US.
*/
?>
<div class="mml_form_body clearfix">
	<div class="mml_col-xs-6 float-label mml_main-col">
		<div class="mml_row clearfix">
			<div class="mml_col-xs-12 mml_control mml_field_wrap mml_movingdate_wrap">
				<input type="text" name="mml_moving_date" placeholder="Moving Date" autocomplete="off" max="200" class="mml_col-xs-12 mml_moving_date mml_date_format_us" value="" required="" readonly="readonly" />
			...
			<div class="mml_col-xs-12 mml_control mml_field_wrap mml_pickupzip_wrap">
				<input type="tel" autocomplete="off" maxlength="5" class="mml_col-xs-12 mml_from_zip" max="200" name="mml_from_zip" placeholder="Pickup Zip" data-abr="us" required="" />
				<label for="mml_from_zip" class="mml_placeholder">Pickup Zip</label>
			...
			<div class="mml_group mml_delivery_group mml_control">
				<div class="mml_col-xs-12 mml_control mml_field_wrap mml_deliverystate_wrap">
					...
					<label for="mml_delivery_state" class="mml_placeholder">Delivery State</label>
	...
	<div class="mml_col-xs-6 float-label mml_main-col">
		<div class="mml_row clearfix"> <!-- ADD THIS -->
	...
	<div class="mml_hidden">
		<input type="hidden" name="from_to_country" value="US">
	</div>
