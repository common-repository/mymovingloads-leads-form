...
/*
 * LEAD FORM :: AU
 * This is the lead form template for AU.
 */
?>
...
<div class="mml_form_body clearfix">
	<div class="mml_col-xs-6 float-label mml_main-col">
		<div class="mml_row clearfix">
			<div class="mml_col-xs-12 mml_control mml_field_wrap mml_movingdate_wrap">
				<input type="text" name="mml_moving_date" placeholder="Moving Date" autocomplete="off" max="200" class="mml_col-xs-12 mml_moving_date mml_date_format_uk" value="" required="" readonly="readonly" />
			...
			<div class="mml_col-xs-12 mml_control mml_field_wrap mml_pickupzip_wrap">
				<input type="tel" autocomplete="off" maxlength="4" class="mml_col-xs-12 mml_from_zip" name="mml_from_zip" placeholder="Pickup Postcode" data-abr="au" required="" />
			...
			<div class="mml_group mml_delivery_group mml_control">
				<div class="mml_col-xs-12 mml_control mml_field_wrap mml_deliverystate_wrap">
					...
					<select name="mml_delivery_state" class="mml_col-xs-12 mml_delivery_state" required="">
						<option value="" selected="" disabled="">Delivery State/Territory</option>
					...
					<label for="mml_delivery_state" class="mml_placeholder">Delivery State/Territory</label>
					<div class="mml_arrow-down"></div>
				</div>
				<div class="mml_col-xs-12 mml_control mml_field_wrap mml_deliverycity_wrap">
					<input type="text" name="mml_delivery_city" placeholder="Delivery City" autocomplete="off" class="mml_col-xs-12 mml_delivery_city" required="" autocapitalize="off"/>
	...
	<div class="mml_col-xs-6 float-label mml_main-col">
		<div class="mml_row clearfix">
			...
			<div class="mml_col-xs-12 mml_control mml_field_wrap mml_name_wrap">
				<input type="text" name="mml_customer_name" placeholder="First &amp; Last Name" max="200" autocomplete="off" class="mml_col-xs-12" required="" autocapitalize="off"/>
			...
			<div class="mml_col-xs-12 mml_control mml_field_wrap mml_phone_wrap">
				<input type="tel" name="mml_customer_phone" placeholder="Your Phone" min="6" max="200" autocomplete="off" class="mml_col-xs-12" required="" />
			...
			<div class="mml_col-xs-12 mml_control mml_field_wrap mml_email_wrap">
				<input type="email" name="mml_customer_email" placeholder="Your Email" max="200" autocomplete="off" class="mml_col-xs-12" required="" />
	...
	<div class="mml_hidden">
		<input type="hidden" name="from_to_country" value="AU">
	</div>
